...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "FridayEveryDay.settings")
...
media_css = {'all': ( '%s/css/jquery.autocomplete.css' % settings.MEDIA_URL, )}
media_js = ('%sjs/admin/jquery.autocomplete.js' % settings.MEDIA_URL, )
